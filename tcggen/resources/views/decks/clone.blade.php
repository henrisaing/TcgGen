<!-- resource view: deck.clone -->
<div id="popup-form">
<form action="/deck/<?=$deck->id?>/copy" method="post">
{{ csrf_field() }}

  name <input type="text" name="name" value="<?=$deck->name?>(copy)"> <br><br>
  ...
  <br>
  <input type="submit" value="Copy Deck">
</form>
</div>